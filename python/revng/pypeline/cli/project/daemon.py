...
from revng.pypeline.daemon.schema_validation import SchemaValidationMiddleware
...
def run_daemon(ctx, host, port, debug, reload, workers, lock):
    ...
    if debug:
        # On debug all input and output are validated against the schema
        app.middleware.append((SchemaValidationMiddleware, {}))
